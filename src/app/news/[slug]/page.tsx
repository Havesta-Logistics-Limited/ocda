  ...
  return (
    <article className="py-16 sm:py-20">
      <Container className="max-w-3xl">
        <Link href="/news" className="inline-flex items-center gap-1.5 text-sm font-semibold text-clay-600 hover:text-clay-500">
          <ArrowLeft className="h-4 w-4" /> Back to News & Events
        </Link>

        <div className="mt-6">
          {post.kind === "event" && (
            <div className="mb-3 flex flex-wrap gap-4 text-sm font-semibold text-clay-600">
        ...
        {post.coverImageUrl && (
          <div className="relative mt-8 aspect-video overflow-hidden rounded-2xl border border-stone-200">
